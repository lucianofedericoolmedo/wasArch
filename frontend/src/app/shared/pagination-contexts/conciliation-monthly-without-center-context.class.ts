...
export class ConciliationMonthlyWithoutCenterContext extends PaginationContext<any> {
  ...
  private search(pageNumber: number, queryData: any): void {
    this.conciliationService.queryMensualSinCentro(pageNumber, this.pageSize, queryData).subscribe((data: PageResponse<any>) => {
