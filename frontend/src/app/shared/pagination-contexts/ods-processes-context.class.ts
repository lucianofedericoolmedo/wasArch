...
export class OdsProcessesContext extends PaginationContext<any> {
  public pageSize = 10;
  ...
  private search(pageNumber: number, queryData: any): void {
    this.processesLogService.queryLogs(pageNumber, this.pageSize, queryData).subscribe((data: PageResponse<any>) => {
