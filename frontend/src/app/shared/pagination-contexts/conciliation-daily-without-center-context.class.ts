...
export class ConciliationDailyWithoutCenterContext extends PaginationContext<any> {
  ...
  private search(pageNumber: number, queryData: any): void {
    this.conciliationService.queryDiarioSinCentro(pageNumber, this.pageSize, queryData).subscribe((data: PageResponse<any>) => {
