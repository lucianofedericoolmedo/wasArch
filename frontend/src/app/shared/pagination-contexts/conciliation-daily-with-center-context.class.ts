...
export class ConciliationDailyWithCenterContext extends PaginationContext<any> {
  ...
  private search(pageNumber: number, queryData: any): void {
    this.conciliationService.queryDiarioConCentro(pageNumber, this.pageSize, queryData).subscribe((data: PageResponse<any>) => {
